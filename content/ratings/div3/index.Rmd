---
title: "Division III Baseball Ratings"
...
ratings <- read.csv("C:/Users/Owner/Desktop/Fieldhouse Analytics/College Baseball/2022 Ratings + Miscellaneous Data - D-III.csv")
...
datatable(ratings, container = sketch, rownames = FALSE, class = "cell-border stripe", options = list(columnDefs = list(list(className = "dt-center", targets = c(0,2:16))), pageLength = 385)) %>% formatRound("CurrentRating", digits = 2) %>% formatRound("ExpWinPct", digits = 3) %>% formatRound("WinsOverExp", digits = 1) %>% formatStyle(columns = c(1:17), fontSize = '90%')
```
