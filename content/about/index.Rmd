...
* Value of home field advantage
  + Ranging from 0 to 1 runs and testing to 4 decimal places
* Whether to include ratings from 2-5 seasons prior in preseason rating
  + Multiple linear regression was used to find best combination of prior year and then tested
...
* SOR (Strength of Record)
  ...
  + A higher value means the team won more often than an average team would have
